...
static void gatts_profile_event_handler(esp_gatts_cb_event_t event, esp_gatt_if_t gatts_if, esp_ble_gatts_cb_param_t *param) {
    ...
    case ESP_GATTS_READ_EVT: {
        ...
        rsp.attr_value.value[0] = 102;
        rsp.attr_value.value[1] = 97;
        rsp.attr_value.value[2] = 98;
        rsp.attr_value.value[3] = 114;
        rsp.attr_value.value[4] = 105;
        rsp.attr_value.value[5] = 122;
        rsp.attr_value.value[6] = 105;
        rsp.attr_value.value[7] = 111;
        rsp.attr_value.value[8] = 112;
        rsp.attr_value.value[9] = 114;
        rsp.attr_value.value[10] = 111;
...
void setup()
{
    ...
    if (ret) {
        printf("Non ho messo il nome, cazzo. Errore: %d", ret);
    }
    else
    {
      printf("Dovrei averlo messo! Errore: %d", ret);
    }
